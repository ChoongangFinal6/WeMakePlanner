	...
	<div>
		...
		<table class='todo_table'>
			...
			<tr>
				...
				<c:if test="${todo.location.length() <=10}"><div id="map"></div><input type="hidden" id="location" name="location" value="0,0"> </c:if>
			<tr>
				<th>반복</th>
				<td><span class="text">${todo.repeat}</span>일 마다</td>
			</tr>
			<tr>
